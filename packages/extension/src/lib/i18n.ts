...
const ptBR: Messages = {
    ...
    statusCloudLoginRequired: "Para usar o salvamento em nuvem, faça login antes em threads-archive.dahanda.dev/scrapbook.",
...
const es: Messages = {
    ...
    statusCloudLoginRequired: "Para usar el guardado en la nube, inicia sesión primero en threads-archive.dahanda.dev/scrapbook.",
...
const vi: Messages = {
    ...
    statusCloudLoginRequired: "Để dùng lưu đám mây, trước tiên hãy đăng nhập tại threads-archive.dahanda.dev/scrapbook.",
