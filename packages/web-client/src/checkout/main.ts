...
const checkoutFeatureCopy: Record<WebLocale, Record<string, string>> = {
  ...
  ja: {
    ...
    "compare-row-mention-scrapbook": "モバイル メンション保存",
  ...
  "pt-BR": {
    ...
    "compare-row-mention-scrapbook": "Salvamento por menção",
    "compare-row-watchlists": "Watchlists",
    "compare-row-searches": "Searches",
    "compare-row-insights": "Insights",
  ...
  es: {
    ...
    "compare-row-mention-scrapbook": "Guardado por mención",
    "compare-row-watchlists": "Watchlists",
    "compare-row-searches": "Searches",
    "compare-row-insights": "Insights",
  ...
  "zh-TW": {
    ...
    "compare-row-mention-scrapbook": "提及留言儲存",
    "compare-row-watchlists": "Watchlists",
    "compare-row-searches": "Searches",
    "compare-row-insights": "Insights",
  ...
  vi: {
    ...
    "compare-row-mention-scrapbook": "Lưu qua mention",
    "compare-row-watchlists": "Watchlists",
    "compare-row-searches": "Searches",
    "compare-row-insights": "Insights",
