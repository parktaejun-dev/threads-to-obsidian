...
var checkoutPriceValue = document.querySelector("#checkout-price-value");
var checkoutPriceNote = document.querySelector("#checkout-price-note");
var billingCycleInput = document.querySelector("input[name='billingCycle'][type='hidden']");
var billingCycleOptions = document.querySelectorAll("input[name='billingCycle'][type='radio']");
